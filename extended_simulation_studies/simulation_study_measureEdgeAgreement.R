...
if(run.K2){
  ...
  save(res.K2, file="data/jointGHS_simulations_K2_edgeAgreement.Rdata")
  
  res.K2[[1]]$true.sparsity
  
  # Print results
  print_results_jointGHS_show_SD(res.K2, fracs.disagreement, include.GHS = F, show.edgedisagreement = T)
  print_edgeDisagreement_jointGHS(res.K2, fracs.disagreement)
}
