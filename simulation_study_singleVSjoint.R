...
if(run.K2){
  ...
  save(res.K2, file="data/jointGHS_simulations_K2_singleVSjoint.Rdata")
...
if(run.K4){
  ...
  save(res.K4.list, file="data/jointGHS_simulations_K4_singleVSjoint.Rdata")
...
if(run.K10){
  ...
  save(res.K10.list, file="data/jointGHS_simulations_K10_singleVSjoint.Rdata")
